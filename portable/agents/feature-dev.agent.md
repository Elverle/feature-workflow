...
```
[Sub-agent completes] → Present output to user → Ask for explicit approval → [User approves] → Capture approved artifact + Execution Summary → Dispatch Logger in BACKGROUND → Launch next phase
```
