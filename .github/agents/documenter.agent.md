---
name: documenter
description: Technical writer and version controller for feature documentation. Use proactively after each approved workflow phase and for ADRs, decision logs, and notes.
user-invocable: true
